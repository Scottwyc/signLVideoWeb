const translations = {
  zh: {
    ...
    resultTitle: '提示',
    copyrightTitle: '版权声明',
    copyrightText: '提交即表示授权组织方进行非商业使用，包括编辑、汇编、多平台发布以及公益传播。组织方不会将投稿用于商业盈利。版权仍归原作者所有。',
  ...
  en: {
    ...
    copyrightText: 'Submission implies authorization for non-commercial use by the organizers, including editing, compilation, multi-platform release, and public welfare promotion. Organizers will not use submissions for commercial profit. Copyright remains with the original authors.',
