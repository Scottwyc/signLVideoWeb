const translations = {
  zh: {
    ...
    orgLabel: '机构 / 组织',
    emailLabel: '邮箱',
    emailHint: '手机上传建议填写 Google Drive App 登录的 Google 邮箱，系统会把上传文件夹共享给此邮箱。',
    countryLabel: '国家 / 地区',
    othersLabel: '其他说明',
    progressIdle: '等待提交',
    ...
    closeHint: '可以关闭此页面。',
    mobileUploadHint: '手机端建议使用填写的 Google 邮箱登录 Google Drive App。提交后可在“与我共享”中查找文件夹，也可复制链接到 Safari、Chrome 或 Drive App 中打开。',
  ...
  en: {
    ...
    emailLabel: 'Email',
    emailHint: 'For mobile upload, use the Google email signed in on the Google Drive app. The upload folder will be shared with this email.',
    ...
    mobileUploadHint: 'On mobile, sign in to the Google Drive app with the email entered above. After submission, check "Shared with me" for the folder, or copy the link and open it in Safari, Chrome, or the Drive app.',
